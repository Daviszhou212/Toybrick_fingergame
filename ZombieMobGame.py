...
player = MySprite()
player.load("./image/farmer walk.png", 96, 96, 8)
player.position = 80, 80
player.direction = 4
player_group.add(player)

#create the zombie sprite
zombie_image = pygame.image.load("./image/zombie walk.png").convert_alpha()
for n in range(0, 4):
    zombie = MySprite()
    zombie.load("./image/zombie walk.png", 96, 96, 8)
...
#create heath sprite
health = MySprite()
health.load("./image/health.png", 32, 32, 1)
